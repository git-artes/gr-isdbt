...
# Title: Rx Demo
# Generated: Tue Jul 14 14:07:21 2015
##################################################
...
class rx_demo(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Rx Demo")
        ...
        self.isdbt_subset_of_carriers_0 = isdbt.subset_of_carriers(96*4*13, 96*4, 2*96*4-1)
        ...
        self.blocks_vector_to_stream_0_2 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 96*4)
