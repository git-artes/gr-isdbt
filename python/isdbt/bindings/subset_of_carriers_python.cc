...
void bind_subset_of_carriers(py::module &m) {
  ...
  py::class_<subset_of_carriers, gr::sync_block, gr::block, gr::basic_block,
             std::shared_ptr<subset_of_carriers>>(m, "subset_of_carriers",
                                                  D(subset_of_carriers))

      .def(py::init(&subset_of_carriers::make), py::arg("total"),
           py::arg("first"), py::arg("last"), D(subset_of_carriers, make))
