...
void bind_hierarchical_combinator(py::module &m) {
  ...
  py::class_<hierarchical_combinator, gr::sync_block, gr::block,
             gr::basic_block, std::shared_ptr<hierarchical_combinator>>(
      m, "hierarchical_combinator", D(hierarchical_combinator))

      .def(py::init(&hierarchical_combinator::make), py::arg("mode"),
           py::arg("segments_A"), py::arg("segments_B"), py::arg("segments_C"),
