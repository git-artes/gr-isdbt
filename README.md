...
- Over the air transmission. We are currently able to receive the signal with an SDR (a B200 worked best for us) and we are successfully testing it on commercial TVs (see examples/tx_demo.grc which uses the TS files we share in our webpage). Please send us your feedback, we are very interested.
